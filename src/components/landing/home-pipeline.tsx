...
/** Recruiting pins on Dropship-style globe (lat/lng from major hubs) */
    ...
    <section className="cv-pipe">
      <div className="cv-pipe-head">
        ...
        <h2 className="cv-section-title" style={{ marginTop: "1rem" }}>
          Track candidates across every stage
        </h2>
        <p className="cv-section-sub">
          See Applied → Screening → Interview → Offer for every role—without leaving CareerVerse AI.
        </p>
      </div>
