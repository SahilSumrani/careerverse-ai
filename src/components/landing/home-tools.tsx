  ...
  return (
    <section className="cv-tabs">
      <div className="cv-tabs-head">
        <span className="cv-tabs-pill">New</span>
        <h2 className="cv-section-title">CareerVerse AI tools</h2>
        <p className="cv-section-sub">
          Voice interviews, resume parsing, scoring, scheduling, and talent alerts—in one CareerVerse account.
        </p>
      </div>
